 ...
 * My GitHub Corner.
 */
@customElement('my-github-corner')
export class MyGitHubCorner extends LitElement {
  static styles = css`
  ...
  /**
   * Fill color for github corner
   */
  @property({ type: String })
  fill = '#151513'

  /**
   * Your GitHub Repo Name, eg: octocat/Spoon-Knife
   */
  @property({ type: String })
  repo = ''
  ...
  /**
   * Position of GitHub Corner, value is left or right
   */
  @property({ type: String })
  position = 'right'
...
declare global {
  interface HTMLElementTagNameMap {
    'my-github-corner': MyGitHubCorner
  }
}
